...
const headingNumber_ = (heading: GoogleAppsScript.Document.ParagraphHeading): number =>
	paragraphHeadingToNumber_.get(heading) ?? Infinity;

export { paragraphHeadingToNumber_, headingNumber_ };
