/**
 * create-long-quotes-slides/defaults.ts
 * 
 * Created by Min-Kyu Lee on 22-12-2023
 * Copyright © 2023 Min-Kyu Lee. All rights reserved. 
*/

import { Nullable, SlideNumber, LongQuoteItem } from "@gsg/shared";
import { DEFAULT_INSERTION_SLIDE_NUMBER } from "../../shared/defaults";

export const createLongQuotesSlidesDefaultTemplateTitleSlideNumber_: Nullable<number> = null;
export const createLongQuotesSlidesDefaultTemplateContentSlideNumber_: Nullable<number> = null;
export const createLongQuotesSlidesDefaultInsertionSlideNumber_: SlideNumber = DEFAULT_INSERTION_SLIDE_NUMBER;
export const createLongQuotesSlidesDefaultLongQuoteSlideItems_: LongQuoteItem[] = [
	{
		title: "Lorem Ipsum 1",
